...
[_CM] = { /* Colemak */
  ...
  {M(0),    KC_LCTL, KC_LALT, MO(_LW), KC_LGUI, KC_SPC,  KC_SPC,  MO(_RS), KC_VOLD, KC_VOLU, KC_MPLY, KC_RALT}
},
[_RS] = { /* RAISE */
  ...
  {KC_TRNS, KC_LCTL, KC_LALT, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN1, KC_TRNS, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
[_LW] = { /* LOWER */
