...
/*
  0. Make sure you are in /planck directory
  1. make clean
  2. reset
...
[_CM] = { /* Colemak / mac|linux */
  {KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_ESC},
  {KC_BSPC, KC_A,    KC_R,    F(10),   KC_T,    KC_D,    KC_H,    KC_N,    F(11),   KC_I,    KC_O,    KC_QUOT},
  {SFT_T(KC_LPRN), KC_Z, KC_X,KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_T(KC_RPRN)},
  {M(0),    KC_LCTL, KC_LALT, MO(_LW), KC_LGUI, KC_SPC,  KC_SPC,  LT(_RS,  KC_ENT), MO(_LW), KC_VOLD, KC_VOLU, KC_RALT}
},
[_CMW] = { /* Colemak / windows */
  {KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_ESC},
  {KC_BSPC, KC_A,    KC_R,    F(10),   KC_T,    KC_D,    KC_H,    KC_N,    F(11),   KC_I,    KC_O,    KC_QUOT},
  {SFT_T(KC_LPRN), KC_Z, KC_X,KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_T(KC_RPRN)},
  {M(0),    KC_LGUI, KC_LALT, MO(_LW), KC_LCTRL, KC_SPC,  KC_SPC,  LT(_RS,  KC_ENT), MO(_LW), KC_VOLD, KC_VOLU, KC_DEL}
},
[_RS] = { /* RAISE */
  {KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC},
  {KC_ESC,  KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_QUOT, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
  {SFT_T(KC_LPRN), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  DF(_QW), KC_COMM, KC_DOT,  KC_SLSH, SFT_T(KC_RPRN)},
  {KC_TRNS, KC_LCTL, KC_LALT, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN1, KC_TRNS, KC_VOLD, KC_VOLU, KC_MPLY, KC_RALT}
},
[_LW] = { /* LOWER */
  {KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC},
  {KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE},
  {KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  DF(_QW), DF(_CM), DF(_CMW), RESET,   KC_TRNS},
  {KC_TRNS, KC_LCTL, KC_LALT, MO(_LW), GUI_T(KC_BSPC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU, KC_MPLY}
},
[_MS] = { /* MOUSE */
...
[_AR] = { /* ARROWS */
  ...
  {KC_ESC,  KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, KC_WBAK, KC_BTN1, KC_TRNS, KC_BTN2, KC_WFWD, KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN1, KC_TRNS, KC_MNXT, KC_VOLD, KC_VOLU, RESET}
}
};
